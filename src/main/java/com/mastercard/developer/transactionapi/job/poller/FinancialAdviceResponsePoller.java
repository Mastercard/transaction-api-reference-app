...
public class FinancialAdviceResponsePoller extends ResponsePoller<FinancialResponseFinancialResponseV02> {
    ...
    public FinancialAdviceResponsePoller(RequestContextManager requestContextManager,
                                         TransactionApiClient transactionApiClient,
                                         ResponseProcessor responseProcessor) {
        super(FlowType.FINANCIAL_ADVICE, requestContextManager, transactionApiClient, responseProcessor);
    }
