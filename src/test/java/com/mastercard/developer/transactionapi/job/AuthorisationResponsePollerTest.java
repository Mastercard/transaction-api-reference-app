...
class AuthorisationResponsePollerTest {
    ...
    @Mock
    private BatchResponse<ResponseAuthorisationResponseV02> testBatchResponse;
    ...
    void whenGetResponses_verifyGetAuthorisationResponses() {
        ...
        // call
        BatchResponse<ResponseAuthorisationResponseV02> actual = authorisationResponsePoller.getResponses();
    ...
    void whenToJson_verifyJsonOutput() {
        // setup
        ResponseAuthorisationResponseV02 testResponse = TestRequestResponseGenerator.getResponseAuthResponseItem();
        // call
